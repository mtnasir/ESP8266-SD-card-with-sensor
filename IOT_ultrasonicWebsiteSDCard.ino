...
void setup(void) {
  ...
  server.on("/WaterLevel",  handleanalogue);
...
void handleRoot() {
  ...
  String path = "IOT test ultrasonic .html";

if (SD.exists("IOT test ultrasonic .html")) {
    Serial.println("IOT test ultrasonic .html exists.");
  } else {
  Serial.println("IOT test ultrasonic .html doesn't exist.");
  }
